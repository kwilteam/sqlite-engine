// Code generated by 'ccgo3 -o vfs.go vfs.c -I../testdata/sqlite-amalgamation-3380500 -lmodernc.org/sqlite/lib -pkgname embedvfs -nocapi -export-externs X -D SQLITE_OS_UNIX -hide=embedFullPathname -hide=embedOpen -hide=embedRead -hide=embedAccess -hide=embedFileSize -hide=embedClose', DO NOT EDIT.
...
// When using this VFS, the sqlite3_file* handles that SQLite uses are
// actually pointers to instances of type EmbedFile.
type EmbedFile = EmbedFile1 /* vfs.c:154:26 */

// Write directly to the file passed as the first argument. Even if the
// file has a write-buffer (EmbedFile.aBuffer), ignore it.
func embedDirectWrite(tls *libc.TLS, p uintptr, zBuf uintptr, iAmt int32, iOfst sqlite_int64) int32 { /* vfs.c:169:12: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
	...
	ofst = libc.Xlseek(tls, (*EmbedFile)(unsafe.Pointer(p)).fd, int64(iOfst), 0)
	if sqlite_int64(ofst) != iOfst {
		return 10 | int32(3)<<8
	}

	nWrite = size_t(libc.Xwrite(tls, (*EmbedFile)(unsafe.Pointer(p)).fd, zBuf, uint64(iAmt)))
...
var __func__ = *(*[17]int8)(unsafe.Pointer(ts + 13)) /* vfs.c:174:2 */

// Flush the contents of the EmbedFile.aBuffer buffer to disk. This is a
// no-op if this particular file does not have a buffer (i.e. it is not
// a journal file) or if the buffer is currently empty.
func embedFlushBuffer(tls *libc.TLS, p uintptr) int32 { /* vfs.c:197:12: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
	...
	libc.X__builtin_abort(tls)
	var rc int32 = 0
	if (*EmbedFile)(unsafe.Pointer(p)).nBuffer != 0 {
		rc = embedDirectWrite(tls, p, (*EmbedFile)(unsafe.Pointer(p)).aBuffer, (*EmbedFile)(unsafe.Pointer(p)).nBuffer, (*EmbedFile)(unsafe.Pointer(p)).iBufferOfst)
		(*EmbedFile)(unsafe.Pointer(p)).nBuffer = 0
	}
	return rc
}

var __func__1 = *(*[17]int8)(unsafe.Pointer(ts + 30)) /* vfs.c:197:42 */

// Write data to a crash-file.
func embedWrite(tls *libc.TLS, pFile uintptr, zBuf uintptr, iAmt int32, iOfst sqlite_int64) int32 { /* vfs.c:267:12: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
	...
	if (*EmbedFile)(unsafe.Pointer(p)).aBuffer != 0 {
		...
		for n > 0 {
			...
			if (*EmbedFile)(unsafe.Pointer(p)).nBuffer == 8192 || (*EmbedFile)(unsafe.Pointer(p)).iBufferOfst+sqlite3_int64((*EmbedFile)(unsafe.Pointer(p)).nBuffer) != i {
				var rc int32 = embedFlushBuffer(tls, p)
				if rc != 0 {
					return rc
				}
			}
			if (*EmbedFile)(unsafe.Pointer(p)).nBuffer == 0 || (*EmbedFile)(unsafe.Pointer(p)).iBufferOfst+sqlite3_int64((*EmbedFile)(unsafe.Pointer(p)).nBuffer) == i {
			} else {
				libc.X__assert_fail(tls, ts+47, ts+93, uint32(294), uintptr(unsafe.Pointer(&__func__4)))
			}
			(*EmbedFile)(unsafe.Pointer(p)).iBufferOfst = i - sqlite3_int64((*EmbedFile)(unsafe.Pointer(p)).nBuffer)

			// Copy as much data as possible into the buffer.
			nCopy = 8192 - (*EmbedFile)(unsafe.Pointer(p)).nBuffer
			if nCopy > n {
				nCopy = n
			}
			libc.Xmemcpy(tls, (*EmbedFile)(unsafe.Pointer(p)).aBuffer+uintptr((*EmbedFile)(unsafe.Pointer(p)).nBuffer), z, uint64(nCopy))
		...
		return embedDirectWrite(tls, p, zBuf, iAmt, iOfst)
	}

	return 0
}

var __func__4 = *(*[11]int8)(unsafe.Pointer(ts + 99)) /* vfs.c:272:2 */

// Truncate a file. This is a no-op for this VFS (see header comments at
// the top of the file).
func embedTruncate(tls *libc.TLS, pFile uintptr, size sqlite_int64) int32 { /* vfs.c:320:12: */
	return 0
}

// Sync the contents of the file to the persistent media.
func embedSync(tls *libc.TLS, pFile uintptr, flags int32) int32 { /* vfs.c:330:12: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
	...
	rc = embedFlushBuffer(tls, p)
	if rc != 0 {
		return rc
	}

	rc = libc.Xfsync(tls, (*EmbedFile)(unsafe.Pointer(p)).fd)
	return func() int32 {
		if rc == 0 {
			return 0
		}
...
var __func__5 = *(*[10]int8)(unsafe.Pointer(ts + 110)) /* vfs.c:330:53 */

// Locking functions. The xLock() and xUnlock() methods are both no-ops.
// The xCheckReservedLock() always indicates that no other process holds
// a reserved lock on the database file. This ensures that if a hot-journal
// file is found in the file-system it is rolled back.
func embedLock(tls *libc.TLS, pFile uintptr, eLock int32) int32 { /* vfs.c:375:12: */
	return 0
}

func embedUnlock(tls *libc.TLS, pFile uintptr, eLock int32) int32 { /* vfs.c:378:12: */
	return 0
}

func embedCheckReservedLock(tls *libc.TLS, pFile uintptr, pResOut uintptr) int32 { /* vfs.c:381:12: */
	*(*int32)(unsafe.Pointer(pResOut)) = 0
	return 0
}

// No xFileControl() verbs are implemented by this VFS.
func embedFileControl(tls *libc.TLS, pFile uintptr, op int32, pArg uintptr) int32 { /* vfs.c:389:12: */
	return 12
}
...
func embedSectorSize(tls *libc.TLS, pFile uintptr) int32 { /* vfs.c:398:12: */
	return 0
}

func embedDeviceCharacteristics(tls *libc.TLS, pFile uintptr) int32 { /* vfs.c:401:12: */
	return 0
}
...
func embedDelete(tls *libc.TLS, pVfs uintptr, zPath uintptr, dirSync int32) int32 { /* vfs.c:472:12: */
	bp := tls.Alloc(545)
	defer tls.Free(545)
	...
	if rc == 0 && dirSync != 0 {
		...
		// var zDir [513]int8 at bp+32, 513
		// Name of directory containing file zPath

		// Figure out the directory name from the path of the file deleted.
		sqlite3.Xsqlite3_snprintf(tls, 512, bp+32, ts+120, libc.VaList(bp+16, zPath))
		*(*int8)(unsafe.Pointer(bp + 32 + 512)) = int8(0)
...
var __func__8 = *(*[12]int8)(unsafe.Pointer(ts + 123)) /* vfs.c:472:74 */
...
func embedDlOpen(tls *libc.TLS, pVfs uintptr, zPath uintptr) uintptr { /* vfs.c:583:13: */
	return uintptr(0)
}

func embedDlError(tls *libc.TLS, pVfs uintptr, nByte int32, zErrMsg uintptr) { /* vfs.c:586:13: */
	sqlite3.Xsqlite3_snprintf(tls, nByte, zErrMsg, ts+135, 0)
	*(*int8)(unsafe.Pointer(zErrMsg + uintptr(nByte-1))) = int8(0)
}

func embedDlSym(tls *libc.TLS, pVfs uintptr, pH uintptr, z uintptr) uintptr { /* vfs.c:590:13: */
	return uintptr(0)
}

func embedDlClose(tls *libc.TLS, pVfs uintptr, pHandle uintptr) { /* vfs.c:593:13: */
	return
}

// Parameter zByte points to a buffer nByte bytes in size. Populate this
// buffer with pseudo-random data.
func embedRandomness(tls *libc.TLS, pVfs uintptr, nByte int32, zByte uintptr) int32 { /* vfs.c:601:12: */
	return 0
}

// Sleep for at least nMicro microseconds. Return the (approximate) number
// of microseconds slept for.
func embedSleep(tls *libc.TLS, pVfs uintptr, nMicro int32) int32 { /* vfs.c:609:12: */
...
func embedCurrentTime(tls *libc.TLS, pVfs uintptr, pTime uintptr) int32 { /* vfs.c:626:12: */
...
func Xsqlite3_embedvfs(tls *libc.TLS) uintptr { /* vfs.c:638:13: */
	return uintptr(unsafe.Pointer(&embedvfs))
}

var embedvfs = sqlite3_vfs{
	iVersion:      1,                                 // iVersion
	szOsFile:      int32(unsafe.Sizeof(EmbedFile{})), // szOsFile
	mxPathname:    512,                               // pNext
	zName:         ts + 173,
	xOpen:         0, // xOpen
	xDelete:       0, // xDelete
	xAccess:       0, // xAccess
...
func init() {
	*(*func(*libc.TLS, uintptr, uintptr, uintptr, int32, uintptr) int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 40)) = embedOpen // vfs.c:646:5:
	*(*func(*libc.TLS, uintptr, uintptr, int32) int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 48)) = embedDelete                 // vfs.c:647:5:
	*(*func(*libc.TLS, uintptr, uintptr, int32, uintptr) int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 56)) = embedAccess        // vfs.c:648:5:
	*(*func(*libc.TLS, uintptr, uintptr, int32, uintptr) int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 64)) = embedFullPathname  // vfs.c:649:5:
	*(*func(*libc.TLS, uintptr, uintptr) uintptr)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 72)) = embedDlOpen                      // vfs.c:650:5:
	*(*func(*libc.TLS, uintptr, int32, uintptr))(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 80)) = embedDlError                      // vfs.c:651:5:
	*(*func(*libc.TLS, uintptr, uintptr, uintptr) uintptr)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 88)) = embedDlSym              // vfs.c:652:5:
	*(*func(*libc.TLS, uintptr, uintptr))(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 96)) = embedDlClose                             // vfs.c:653:5:
	*(*func(*libc.TLS, uintptr, int32, uintptr) int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 104)) = embedRandomness            // vfs.c:654:5:
	*(*func(*libc.TLS, uintptr, int32) int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 112)) = embedSleep                          // vfs.c:655:5:
	*(*func(*libc.TLS, uintptr, uintptr) int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&embedvfs)) + 120)) = embedCurrentTime                  // vfs.c:656:5:
}

var ts1 = "TODO %s:%i:\n\x00embedDirectWrite\x00embedFlushBuffer\x00p->nBuffer==0 || p->iBufferOfst+p->nBuffer==i\x00vfs.c\x00embedWrite\x00embedSync\x00%s\x00embedDelete\x00Loadable extensions are not supported\x00embed\x00"
