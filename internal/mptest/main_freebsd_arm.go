...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) int32 {
	var n int32 = 0
	for *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), ts+896, uint32(5)) != 0 || !(__sbistype(tls, int32(*(*uint8)(unsafe.Pointer(z + uintptr(n+5)))), uint32(X_CTYPE_S)) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) int32 {
	...
	for *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), ts+902, uint32(7)) == 0 && __sbistype(tls, int32(*(*uint8)(unsafe.Pointer(z + uintptr(n+7)))), uint32(X_CTYPE_S)) != 0 ||
			stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), ts+910, uint32(6)) == 0 && __sbistype(tls, int32(*(*uint8)(unsafe.Pointer(z + uintptr(n+6)))), uint32(X_CTYPE_S)) != 0 {
			return n + len
		}
		if libc.Xstrncmp(tls, z+uintptr(n), ts+917, uint32(4)) == 0 && __sbistype(tls, int32(*(*uint8)(unsafe.Pointer(z + uintptr(n+4)))), uint32(X_CTYPE_S)) != 0 {
