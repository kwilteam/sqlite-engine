...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) int32 {
	var n int32 = 0
	for *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), ts+896, uint32(5)) != 0 || !(int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(*(*uint8)(unsafe.Pointer(z + uintptr(n+5)))))*2)))&int32(_ISspace) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) int32 {
	...
	for *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), ts+902, uint32(7)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(*(*uint8)(unsafe.Pointer(z + uintptr(n+7)))))*2)))&int32(_ISspace) != 0 ||
			stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), ts+910, uint32(6)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(*(*uint8)(unsafe.Pointer(z + uintptr(n+6)))))*2)))&int32(_ISspace) != 0 {
			return n + len
		}
		if libc.Xstrncmp(tls, z+uintptr(n), ts+917, uint32(4)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(*(*uint8)(unsafe.Pointer(z + uintptr(n+4)))))*2)))&int32(_ISspace) != 0 {
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	*(*int32)(unsafe.Pointer(bp + 372)) = 1
	...
	for libc.AssignInt32(&c, int32(*(*uint8)(unsafe.Pointer(zScript + uintptr(ii))))) != 0 {
		...
		if libc.Xstrcmp(tls, bp+376, ts+1207) == 0 {
		...
		} else if libc.Xstrcmp(tls, bp+376, ts+1213) == 0 {
			...
			libc.Xexit(tls, rc)
		} else if libc.Xstrcmp(tls, bp+376, ts+1218) == 0 {
			if g.iTrace == 1 {
				logMessage(tls, ts+1202, libc.VaList(bp+32, len-1, zScript+uintptr(ii)))
			}
			stringReset(tls, bp+360)
		} else if libc.Xstrcmp(tls, bp+376, ts+1227) == 0 && iClient > 0 {
			finishScript(tls, iClient, taskId, 1)
		} else if libc.Xstrcmp(tls, bp+376, ts+1234) == 0 {
			stringReset(tls, bp+360)
		} else if libc.Xstrcmp(tls, bp+376, ts+1240) == 0 {
			var jj int32
			...
			g.nTest++
			stringReset(tls, bp+360)
		} else if libc.Xstrcmp(tls, bp+376, ts+1291) == 0 || libc.Xstrcmp(tls, bp+376, ts+1296) == 0 {
			var jj int32
			var zAns uintptr = zScript + uintptr(ii)
			var zCopy uintptr
			...
			g.nTest++
			stringReset(tls, bp+360)
		} else if libc.Xstrcmp(tls, bp+376, ts+1347) == 0 {
			logMessage(tls, ts+438, libc.VaList(bp+136, (*String)(unsafe.Pointer(bp+360)).z))
		} else if libc.Xstrcmp(tls, bp+376, ts+1354) == 0 {
		...
		} else if libc.Xstrcmp(tls, bp+376, ts+1405) == 0 {
			var jj int32
		...
		} else if libc.Xstrcmp(tls, bp+376, ts+1411) == 0 {
			var jj int32
			var rc int32
			var pStmt uintptr
			...
			sqlite3.Xsqlite3_finalize(tls, pStmt)
		} else if libc.Xstrcmp(tls, bp+376, ts+1426) == 0 {
			ii = ii + findEndif(tls, zScript+uintptr(ii)+uintptr(len), 0, bp+372)
		} else if libc.Xstrcmp(tls, bp+376, ts+1431) == 0 {
		} else if libc.Xstrcmp(tls, bp+376, ts+1437) == 0 && iClient == 0 {
			var iNewClient int32 = libc.Xatoi(tls, bp+406)
			if iNewClient > 0 {
				startClient(tls, iNewClient)
			}
		} else if libc.Xstrcmp(tls, bp+376, ts+1443) == 0 && iClient == 0 {
			var iTimeout int32
			if nArg >= 2 {
		...
		} else if libc.Xstrcmp(tls, bp+376, ts+1463) == 0 && iClient == 0 {
			...
			len = len + iEnd
			iBegin = ii + len
		} else if libc.Xstrcmp(tls, bp+376, ts+1567) == 0 {
			test_breakpoint(tls)
		} else if libc.Xstrcmp(tls, bp+376, ts+1578) == 0 {
	...
	if iClient > 0 {
		...
		for 1 != 0 {
			*(*uintptr)(unsafe.Pointer(bp + 244)) = uintptr(0)
			...
			if g.iTrace != 0 {
				logMessage(tls, ts+2902, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(bp + 244)), *(*int32)(unsafe.Pointer(bp + 240))))
			}
			runScript(tls, iClient, *(*int32)(unsafe.Pointer(bp + 240)), *(*uintptr)(unsafe.Pointer(bp + 236)), *(*uintptr)(unsafe.Pointer(bp + 244)))
			if g.iTrace != 0 {
				logMessage(tls, ts+2916, libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(bp + 244)), *(*int32)(unsafe.Pointer(bp + 240))))
			}
